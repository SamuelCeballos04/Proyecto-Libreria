...
var fantasia = datos =>{
    ...
    app.libros.map(libro=>{
        ...
        <div class="product-image">
                <img src=${libro.img} class="product-thumb" alt="" id="${libro.id}" onclick="abrir(this,user,pass)">
    </div>
    <div class="product-info">
        
            <h2 class="product-brand" id="${libro.id}" onclick="abrir(this, user, pass)">${libro.nombre}</h2>
...
document.getElementById("caja-libro-romance").innerHTML = html;
}
...
document.getElementById("caja-libro-comic").innerHTML = html;
}
